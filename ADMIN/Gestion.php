    ...
    <nav>
       <h5 class="menu">MENU</h5>
        <ul class="nav-list">
                ...
                <li><a href="profdispo.php" class="<?= (basename($_SERVER['PHP_SELF'])=='profdispo.php') ? 'nav-active' : '' ?>"><img src="../icons/dispo.jpeg" alt="20" width="30">Enseignants disponibles</a></li>
